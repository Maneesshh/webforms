...
<asp:GridView ID="EventsGridView" runat="server" AutoGenerateColumns="false">
    <Columns>
        ...
        <asp:TemplateField HeaderText="Action">
            <ItemTemplate>
  <asp:Button ID="EditButton" runat="server" Text="Edit" OnClick="Edit_Click" CommandArgument='<%# Eval("eid") %>'/>           
                <asp:Button ID="DeleteButton" runat="server" Text="Delete" OnClick="Delete_Click" CommandArgument='<%# Eval("eid") %>'/>
            </ItemTemplate>
        </asp:TemplateField>
    </Columns>
</asp:GridView>
